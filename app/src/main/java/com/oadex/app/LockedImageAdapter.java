 ...
 */
public class LockedImageAdapter extends BaseAdapter {
    private Context mContext;

    public LockedImageAdapter(Context c){
        mContext = c;
    }
    ...
    private Integer[] mThumbIds = {
            R.drawable.user_locked,R.drawable.location_pin,
            R.drawable.newspaper,R.drawable.reading,
            R.drawable.users_group_locked,R.drawable.calendar,
